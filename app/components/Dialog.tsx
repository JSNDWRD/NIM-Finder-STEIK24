...
export default function Dialog({
  ...
  return (
    <div
      ...
      className={`absolute top-0 left-1/2 flex h-dvh w-dvw -translate-x-1/2 items-center justify-center p-2 backdrop-blur-md bg-black/50 transition-opacity ${data ? "z-[100] opacity-100" : "pointer-events-none -z-50 opacity-0"}`}
    >
